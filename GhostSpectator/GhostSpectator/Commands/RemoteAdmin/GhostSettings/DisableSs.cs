...
{
    public class DisableSs : ICommand
    {
        public DisableSs(string command, string description, string[] aliases)
        {
        ...
        public bool Execute(ArraySegment<string> arguments, ICommandSender sender, out string response)
        {
            ...
            {
                response = translation.DisableSsFail;
                return false;
            }
            SSGhostSpectator.Singleton.Disable();
            response = translation.DisableSsSuccess;
            return true;
        }
