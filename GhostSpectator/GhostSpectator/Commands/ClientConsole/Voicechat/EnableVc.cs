...
{
    public class EnableVc : ICommand, IUsageProvider
    {
        public EnableVc(string command, string description, string[] aliases)
        {
        ...
        public bool Execute(ArraySegment<string> arguments, ICommandSender sender, out string response)
        {
            ...
            success.Append($"{Translation.EnableVcSuccess}:");
            failure.Append($"{Translation.EnableVcFail}:");
            failurePerm.Append($"{Translation.EnableVcPermFail}:");
