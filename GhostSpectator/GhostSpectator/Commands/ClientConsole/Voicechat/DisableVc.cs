...
{
    public class DisableVc : ICommand, IUsageProvider
    {
        public DisableVc(string command, string description, string[] aliases)
        {
        ...
        public bool Execute(ArraySegment<string> arguments, ICommandSender sender, out string response)
        {
            ...
            success.Append($"{Translation.DisableVcSuccess}:");
            failure.Append($"{Translation.DisableVcFail}:");
            failurePerm.Append($"{Translation.DisableVcPermFail}:");
