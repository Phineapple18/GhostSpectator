...
namespace GhostSpectator.Extensions
{
    internal static class DuelExtensions
    {
        ...
        {
            player.GetComponent<GhostComponent>().DuelPartner = null;
            opponent.GetComponent<GhostComponent>().DuelPartner = null;
            ...
            Log.Debug($"Player {player.Nickname} has abandoned duel with player {opponent.Nickname}.", Config.Debug, PluginName);
        }
        ...
        internal static void AbortDuel(Player player, Player opponent)
        {
            if (opponent != null)
            {
                ...
                Log.Debug($"Duel between players {player.Nickname} and {opponent.Nickname} has been aborted.", Config.Debug, PluginName);
            }
        }        
        ...
        internal static void AcceptDuel(this Player receiver, Player sender, List<Player> allSenders)
        {
            ...
            Log.Debug($"Player {receiver.Nickname} has accepted a duel request from player {sender.Nickname}.", Config.Debug, PluginName);
        ...
        {
            winner.GetComponent<GhostComponent>().DuelPartner = null;
            loser.GetComponent<GhostComponent>().DuelPartner = null;
        ...
        private static IEnumerator<float> PrepareDuel(Player player1, Player player2, string coroutineName)
        {
            ...
            player1.GetComponent<GhostComponent>().DuelPartner = player2;
            player2.GetComponent<GhostComponent>().DuelPartner = player1;
            ...
            Log.Debug($"The duel between players {player1.Nickname} and {player2.Nickname} has begun.", Config.Debug, PluginName);
            yield break;
        }
        ...
        internal static void RejectDuel(this Player receiver, Player sender)
        {
            ...
            Log.Debug($"Player {receiver.Nickname} rejected a duel request from player {sender.Nickname}.", Config.Debug, PluginName);
        }
        ...
        internal static void RequestDuel(this Player sender, Player receiver, Player existingReceiver = null)
        {
            ...
            else
            {
                ...
                Log.Debug($"Player {sender.Nickname} has cancelled his duel request with {existingReceiver.Nickname}.", Config.Debug, PluginName);
            }
            ...
            Log.Debug($"Player {sender.Nickname} has sent a duel request to player {receiver.Nickname}.", Config.Debug, PluginName);
        }
        ...
        internal static bool TryAbortDuelPreparation(Player player, out string nickname)
        {
            ...
            CoroutineHandle pendingDuel = DuelCoroutines.Keys.First(c => c.Tag.Contains(player.PlayerId.ToString()));
            ...
            Log.Debug($"Duel preparation between players {player.Nickname} and {opponent.Nickname} has been aborted.", Config.Debug, PluginName);
            return true;
        }
        ...
        internal static bool TryRemoveDuelRequest(Player player, out string nickname, bool onlySentRequest = true)
        {
            ...
            if (DuelRequests.ContainsKey(player))
            {
                ...
                nickname = opponent.Nickname;
                result = true;
                Log.Debug($"Duel request of player {player.Nickname} has been removed.", Config.Debug, PluginName);
            }
        ...
        {
            CoroutineHandle pendingDuel = DuelCoroutines.Keys.FirstOrDefault(c => c.Tag.Contains(player.PlayerId.ToString()));
